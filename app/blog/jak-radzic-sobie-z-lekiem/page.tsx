...
export const metadata: Metadata = {
  ...
  description:
    'Jak radzić sobie z lękiem? Poznaj typowe objawy lęku, proste sposoby samopomocy i sprawdź, kiedy warto umówić konsultację u psychologa.',
};
...
export default function Page() {
  return (
    <main id="tresc" className="container section max-w-3xl">
      ...
      <h2 className="mt-12 text-4xl text-green">Kiedy warto szukać wsparcia psychologa</h2>
      <p className="mt-4 leading-8 text-ink/80">
        ...
        zobowiązuje do niczego: to okazja, by w spokoju opowiedzieć o swoim doświadczeniu. W gabinecie można
        porozmawiać stacjonarnie lub online.
      </p>
      ...
      <p className="mt-4 leading-8 text-ink/80">
        ...
        Jeśli czuje Pan/Pani, że lęk staje się zbyt ciężki, zapraszam do kontaktu – pierwszy krok bywa
