...
export const metadata: Metadata = {
  ...
  description: 'Pierwsza wizyta u psychologa: sprawdź, jak wygląda konsultacja, ile trwa, o czym rozmawiamy i czy trzeba przygotować się do spotkania.',
};
...
export default function Page() {
  return (
    <main id="tresc" className="container section max-w-3xl">
      ...
      <h2 className="mt-12 text-4xl text-green">Spotkania stacjonarnie i online</h2>
      <p className="mt-4 leading-8 text-ink/80">Jeśli interesuje Pana/Panią pierwsza wizyta u psychologa, zapraszam do gabinetu. Dostępna jest także forma online, wybierana przez osoby, które wolą rozmawiać z domu albo mieszkają z dala od gabinetu. W obu formach spotkanie trwa 50 minut i służy przede wszystkim spokojnemu poznaniu się.</p>
