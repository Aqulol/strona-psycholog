...
export const metadata: Metadata = {
  ...
  description: 'Wypalenie zawodowe i jego objawy: sprawdź, czym jest przewlekłe przeciążenie, kiedy porozmawiać z psychologiem i jak wygląda wsparcie.',
};
...
export default function Page() {
  return (
    <main id="tresc" className="container section max-w-3xl">
      ...
      <p className="mt-4 leading-8 text-ink/80">Jeśli szuka Pan/Pani wsparcia w obszarze wypalenia zawodowego – psycholog może pomóc. Spotkania odbywają się stacjonarnie w gabinecie oraz online. Forma zdalna może być wygodna przy intensywnej pracy lub dla osób mieszkających w innej miejscowości.</p>
